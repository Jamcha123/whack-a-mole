    ...
    constructor(user, options, staticData, anonymousUserId, headerUserAgent) {
        ...
        this.user_id =
            user.isAnonymous || !user.user_id
                ? user.user_id || anonymousUserId || uuid.v4()
                : user.user_id;
...
class DevCycleClient {
    ...
    constructor(sdkKey, user, options = {}) {
        ...
        this.initializeOnConfigFailure = (user, err) => {
            ...
            this.settleOnInitialized(this, err instanceof types$1.UserError ? err : null);
        };
    ...
    variable(key, defaultValue) {
        ...
        const type = types$1.getVariableTypeFromValue(defaultValue, key, this.logger, true);
        ...
        try {
            ...
            (_c = this.eventQueue) === null || _c === void 0 ? void 0 : _c.queueAggregateEvent({
                ...
                metaData: {
                    ...
                    type: types$1.getVariableTypeFromValue(variable.defaultValue, variable.key, this.logger),
...
function initializeDevCycle(sdkKey, userOrOptions, optionsArg = {}) {
    if (!sdkKey) {
        throw new types$1.UserError('Missing SDK key! Call initialize with a valid SDK key');
    }
    if (!sdkKey.startsWith('client') &&
        !sdkKey.startsWith('dvc_client') &&
        !(optionsArg === null || optionsArg === void 0 ? void 0 : optionsArg.next)) {
        throw new types$1.UserError('Invalid SDK key provided. Please call initialize with a valid client SDK key');
    }
...
Object.defineProperty(exports, 'UserError', {
    enumerable: true,
    get: function () { return types$1.UserError; }
});
