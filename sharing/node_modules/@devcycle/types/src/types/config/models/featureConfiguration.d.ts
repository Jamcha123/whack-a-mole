...
export declare class RolloutStage {
    /**
...
export declare class TargetDistribution<IdType = string> {
    /**
 ...
 */
export declare class Target<IdType = string> {
    _id: IdType;
    /**
...
export declare class FeaturePrerequisites<IdType = string> {
    _feature: IdType;
    comparator: '=' | '!=';
}
export declare class FeatureWinningVariation<IdType = string> {
    _variation: IdType;
    updatedAt: Date;
}
/**
 ...
 */
export declare class FeatureConfiguration<IdType = string> {
    /**
     * Mongo primary _id.
     */
    _id: IdType;
