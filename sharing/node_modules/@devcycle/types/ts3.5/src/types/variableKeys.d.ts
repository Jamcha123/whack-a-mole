...
type DynamicBaseVariableDefinitions = keyof CustomVariableDefinitions extends never ? {
...
export type CustomVariablesDefined = keyof CustomVariableDefinitions extends never ? false : true;
export type InferredVariableType<K extends VariableKey, DefaultValue extends VariableDefinitions[K]> = CustomVariablesDefined extends true ? VariableDefinitions[K] : VariableTypeAlias<DefaultValue>;
export {};
