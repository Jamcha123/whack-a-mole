...
export declare abstract class ConfigSource {
     ...
     */
    abstract getConfig<T extends boolean = false>(sdkKey: string, kind: 'server' | 'bootstrap', obfuscated: boolean, lastModifiedThreshold?: string, skipLastModified?: T): Promise<{
     ...
     * @param obfuscated
     */
    abstract getConfigURL(sdkKey: string, kind: 'server' | 'bootstrap', obfuscated: boolean): string;
    protected isLastModifiedHeaderOld(lastModifiedHeader: string | null): boolean;
}
