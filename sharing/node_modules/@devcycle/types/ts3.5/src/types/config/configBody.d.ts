import { Project, Environment, Variable, Variation, ListAudience, Audience, FeatureConfiguration, Rollout, RolloutStage, Feature, Target } from './models';
export { Rollout, RolloutStage, FeatureConfiguration, Feature, Variation, Audience, Variable, Project, Environment, };
export { Rollout as PublicRollout, RolloutStage as PublicRolloutStage, FeatureConfiguration as PublicFeatureConfiguration, Feature as PublicFeature, Variation as PublicVariation, Audience as PublicAudience, Variable as PublicVariable, Target as PublicTarget, Project as PublicProject, Environment as PublicEnvironment, };
export declare class ConfigBody<IdType = string> {
    /**
