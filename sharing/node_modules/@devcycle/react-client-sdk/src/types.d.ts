import type { DevCycleOptions, DevCycleUser, DVCCustomDataJSON } from '@devcycle/js-client-sdk';
type WithSDKKey = {
    sdkKey: string;
};
...
export type ProviderConfig<CustomData extends DVCCustomDataJSON = DVCCustomDataJSON> = (WithSDKKey | WithEnvironmentKey) & {
